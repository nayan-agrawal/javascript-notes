...
Now, let us look at the differences between promises and async/await
![Difference between promises and async/await](../assets/images/diff-promises-async-await.png)